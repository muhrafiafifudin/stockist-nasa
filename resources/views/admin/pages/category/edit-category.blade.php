                            ...
                            <form action="{{ route('admin.kategori.update', $categories->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="category" id="category" value="{{ $categories->category }}" placeholder="Masukkan Nama Kategori ..." required>
                                        <small id="categoryText" class="form-text text-muted">Nama kategori untuk identitas setiap produk.</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="category">Slug</label>
                                        <input type="text" class="form-control" name="slug" id="slug" value="{{ $categories->slug }}" placeholder="Masukkan Slug Kategori ..." required>

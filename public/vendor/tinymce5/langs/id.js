tinymce.addI18n("id", {
    ...
    "Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.":
        "Penempelan sekarang dalam modus teks biasa. Konten sekarang akan disisipkan sebagai teks biasa sampai Anda memadamkan pilihan ini.",
    Fonts: "Huruf",
    ...
    "Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.":
        "Id harus dimulai dengan huruf, dan hanya diikuti oleh huruf, angka, koma, titik, titik koma atau garis bawah.",
    ...
    "The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?":
        "Tautan yang anda masukkan sepertinya adalah alamat email. Apakah Anda ingin menambahkan prefiks mailto: yang dibutuhkan?",
    "The URL you entered seems to be an external link. Do you want to add the required http:// prefix?":
        "Tautan yang anda masukkan sepertinya adalah tautan eksternal. Apakah Anda ingin menambahkan prefiks http:// yang dibutuhkan?",
    ...
    "Could not find the specified string.":
        "Tidak dapat menemukan string yang dimaksud.",
    ...
    "Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help":
        "Area teks kaya. Tekan ALT-F9 untuk menu. Tekan ALT-F10 untuk toolbar. Tekan ALT-0 untuk bantuan",
    ...
    Symbols: "Simbol",
    Arrows: "Panah",
    "User Defined": "Ditentukan Pelanggan",
    ...
    "yuan character, in hong kong and taiwan":
        "karakter yuan, di hong kong dan taiwan",
    ...
    "Error: Form submit field collision.":
        "Kesalahan: Benturan bidang pengiriman bentuk.",
    "Error: No form element found.":
        "Kesalahan: tidak ditemukan elemen bentuk.",
    Update: "Perbarui",
    ...
    "Switch to or from fullscreen mode":
        "Alihkan ke atau dari mode layar penuh",
